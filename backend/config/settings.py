...
ALLOWED_HOSTS = [h for h in os.environ.get("DJANGO_ALLOWED_HOSTS", "localhost,127.0.0.1,backend").split(",") if h]
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "anarkz"),
        "USER": os.environ.get("POSTGRES_USER", "anarkz"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "anarkz"),
...
# Serve static files in production (gunicorn) without nginx volume mounts
STORAGES = {
